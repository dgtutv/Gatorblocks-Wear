...
public class block8Settings extends WearableActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_block8_settings);
        configureBackButton();
        configureColor();
        ...
        simpleEditText.setText(prefs.getString("class8","2-4"));                  //set textbox to equal current class
    ...
    private void configureColor() {
        ...
        Block1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(block8Settings.this, colorBlock8.class));
    ...
    private void configureBackButton(){
        ...
        backbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(block8Settings.this, classes.class));
    ...
    public void test(String enteredText){
        ...
        editor.putString("class8", enteredText);
        editor.commit();
    }
}
