...
public class block2Settings extends WearableActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_block2_settings);
        configureBackButton();
        configureColor();
        ...
        simpleEditText.setText(prefs.getString("class2","1-2"));    //set textbox to equal current class
    ...
    private void configureColor() {
        ...
        Block1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(block2Settings.this, colorBlock2.class));
    ...
    private void configureBackButton(){
        ...
        backbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(block2Settings.this, classes.class));
    ...
    public void test(String enteredText){
        ...
        editor.putString("class2", enteredText);
        editor.commit();
    }
