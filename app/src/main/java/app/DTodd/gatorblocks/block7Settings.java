...
public class block7Settings extends WearableActivity{

    private TextView mTextView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_block7_settings);
        configureBackButton();
        configureColor();
        ...
        simpleEditText.setText(prefs.getString("class7","2-3"));                   //set textbox to equal current class
    ...
    private void configureColor() {
        ...
        Block1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(block7Settings.this, colorBlock7.class));
    ...
    private void configureBackButton(){
        ...
        backbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(block7Settings.this, classes.class));
    ...
    public void test(String enteredText){
        ...
        editor.putString("class7", enteredText);
        editor.commit();
    }
}
