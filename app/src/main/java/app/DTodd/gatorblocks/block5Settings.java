...
public class block5Settings extends WearableActivity{

    private TextView mTextView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_block5_settings);
        configureBackButton();
        configureColor();
        ...
        simpleEditText.setText(prefs.getString("class5","2-1"));                    //set textbox to equal current class
    ...
    private void configureColor() {
        ...
        Block1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(block5Settings.this, colorBlock5.class));
    ...
    private void configureBackButton(){
        ...
        backbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(block5Settings.this, classes.class));
    ...
    public void test(String enteredText){
        ...
        editor.putString("class5", enteredText);
        editor.commit();
    }
}
